...
<div class="container-fluid pt-4 px-4" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
    <div class="row g-4">
        <div class="col-sm-12 ">
            ...
            <form action="{{route('admin.gallery.udpate')}}" enctype="multipart/form-data" method="post">
                @csrf
                <input type="hidden" name="id" value="{{$gadata->id}}" />
                <div class="bg-secondary rounded h-100 p-4 ">
                    <div class="bg-secondary rounded h-100 p-4">
                        <div class="row">
                            ...
                            <!-- <div class="col-md-6 ">
                                <a href="{{route('admin.gallery.index')}}">
                                    <button type="button" class="btn btn-primary m-2">VIEW gallery<i class="fa fa-home ms-2"></i></button>
                                </a>
                            </div> -->
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" pattern="[a-zA-Z0-9]*$" value="{{$gadata->name}}" id="floatingInput" name="name" placeholder="name@example.com">
                        ...
                        <div class="form-floating">
                            <button type="submit" class="btn btn-primary mt-3 w-100 btn-block">EDIT gallery</button>
